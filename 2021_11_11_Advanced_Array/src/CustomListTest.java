...
abstract class CustomListTest {
    ...
    @Test
    public void testRemoveById_idLast() {
        intList.add(1);
        intList.add(3);
        intList.add(3);
        intList.add(4);
    ...
    public void testInsertFirstIndex() {
        ...
        intList.insert(0, 8);
        assertListContents(new int[]{8, 1, 2, 3});
    }
    ...
    public void testInsertLastIndex() {
        ...
        intList.insert(4, 8);
        assertListContents(new int[]{1, 2, 3, 4, 8});
    }

    @Test
    public void testInsertMiddleIndex() {
        intList.add(1);
        intList.add(2);
        intList.add(3);
        intList.add(4);
        ...
        intList.insert(2, 8);
        assertListContents(new int[]{1, 2, 8, 3, 4});
    }

    @Test
    public void testInsertZeroIndex() {
        intList.insert(0, 8);
        assertListContents(new int[]{8});
    }
    ...
    public void testIterator_zeroElements() {
        Iterator<Integer> iterator = intList.getIterator();
        boolean currentNumber = iterator.hasNext();
        assertEquals(false, currentNumber);
    }
