...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person one = new Person("one", 12);
        Person two = new Person("two", 13);
        Person three = new Person("three", 5);

        Stream<Person> personsStream = Stream.of(one, two, three);
        SalaryCollector salaryCollector = new SalaryCollector();
        int res = personsStream.collect(salaryCollector);
