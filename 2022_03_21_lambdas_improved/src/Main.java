...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BiFunction<Integer, Integer, Integer> one = (a, b) -> Integer.parseInt(a + "" + b);
        System.out.println(one.apply(2, 3));

        Predicate<String> two = (str) -> str.length() == 3;
        System.out.println(two.test("fhgj"));

        Predicate<String> three = (str) -> str.length() % 2 == 0;
        System.out.println(three.test("jhfgh"));

        Function<String, String> four = String::toUpperCase;
        System.out.println(four.apply("hghh"));

        Function<String, String> five = (str) -> str.length() == 4 ? "****" : str;
        System.out.println(five.apply("jjjjj"));

        Function<String, String> six = (str) -> "!".concat(str).concat("!");
        System.out.println(six.apply("hello"));

        Consumer<String> seven = System.out::println;
        seven.accept("hello world");


        String input = "ghh hghghg g";
        Predicate<String> predicate = (str) -> str.length() == 3;
        Function<String, String> function = String::toUpperCase;
        System.out.println(transforming(input, predicate, function));
    }
